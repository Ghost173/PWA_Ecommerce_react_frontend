            ...
            if (newarrivalproductslist.discount_price === 'na') {
                ...
                return <div key={i.toString} className="p-1">
                    ...
                    <Card className='image-box card w-100 shadow'>
                        ...
                        <p className='product-name-on-card'> {newarrivalproductslist.product_title}</p>
                        <p className='product-price-on-card'>Rs:{newarrivalproductslist.discount_price} <strike className="text-secondary">{newarrivalproductslist.product_price}</strike></p>
                    </Card>
                    </Link>
